...
from e2m.parsers.doc.pdf_parser import PdfParser
...
def test_pdf_parse_by_surya_layout(pdf_parser_surya_layout):
    assert pdf_parser_surya_layout.get_parsed_data("file") != None

def test_pdf_parse_by_marker(pdf_parser_marker):
    assert pdf_parser_marker.get_parsed_data("file") != None

def test_pdf_parse_by_unstructured(pdf_parser_unstructured):
    assert pdf_parser_unstructured.get_parsed_data("file") != None
